...
const fixtures = [
  ...
  {
    id: "video:veo2-ocean",
    prompt: "Use veo 2 to generate a video of ocean waves crashing on a beach",
    expected: {
      type: "video",
  ...
  },
  {
    ...
    prompt: "Generate video with veo 3 model: a forest scene with sunlight filtering through trees",
    expected: {
      type: "video",
      model: expect.stringMatching(/^veo-3\.0-(fast-)?generate-001$/),
      prompt: expect.stringMatching(/.+/),
  ...
  },
  {
    ...
    prompt: "Use veo 3 fast model to create a video of a sports car driving through city streets",
    expected: {
      type: "video",
      model: expect.stringMatching(/^veo-3\.0-(fast-)?generate-001$/),
      prompt: expect.stringMatching(/.+/),
  ...
  },
  {
    ...
    prompt: "Quick 720p video of busy city traffic with cars and pedestrians moving",
    expected: {
      type: "video",
      model: expect.stringMatching(/^veo-3\.0-(fast-)?generate-001$/),
      prompt: expect.stringMatching(/.+/),
